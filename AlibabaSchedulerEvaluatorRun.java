...
public class AlibabaSchedulerEvaluatorRun {
    ...
    private String toMachine(String inst, int machineIt, boolean doCheck)
    {
        ...
        // if (machineIt==798){
        //     System.out.println("xy" + hasApp.keySet());
        // }
        if (doCheck) {
            // 检查互斥规则
            int nowHas = 0;
            ...
            for (Integer conditionalApp : hasApp.keySet()) {
                ...
                // System.out.println(nowHas + 1 > appInterference[conditionalApp].get(appIt));
                if(nowHas + 1 > appInterference[conditionalApp].get(appIt)) {
                    ...
                    // System.out.println("App Interference, inst: " + inst + ", "
                    //     + apps[conditionalApp] + " -> " + apps[appIt] + ", "
                    //     + (nowHas + 1) + " > " + appInterference[conditionalApp].get(appIt));
                    end=1;
                }
            ...
            for (Integer checkApp : hasApp.keySet()) {
                ...
                // System.out.println(hasApp.get(checkApp) > appInterference[appIt].get(checkApp));
            ...
            for (int i = 0; i < k; i++)
                ...
                // System.out.println(dcmp(machineResourcesUsed[machineIt][i] + appResources[appIt][i] - machineResources[machineIt][i]) > 0);
